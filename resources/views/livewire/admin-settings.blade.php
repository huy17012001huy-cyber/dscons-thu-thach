        ...
        <form wire:submit="save" class="flex flex-col gap-4">
            ...
            <div class="flex gap-3">
                <div style="flex:1;">
                    ...
                    <input wire:model="mailFromName" type="text" class="input" placeholder="Website Thử Thách">
                ...
                <div style="flex:1;">
                    ...
                    <input wire:model="mailFromAddress" type="email" class="input" placeholder="no-reply@website-thu-thach.local">
