...
class RecruiterEntitlement extends Model
{
    ...
    {
        return $this->belongsTo(RecruiterOrder::class, 'order_id');
    }

    /** @return HasMany<RecruiterCreditLedger, $this> */
    public function ledger(): HasMany
    {
        return $this->hasMany(RecruiterCreditLedger::class, 'entitlement_id');
    }

    public function availableCredits(): int
    {
        return max(0, $this->credits_total - $this->credits_reserved - $this->credits_used);
    }
