...
class RecruitmentContactRequest extends Model
{
    ...
    {
        return $this->belongsTo(EngineerCv::class, 'cv_id');
    }

    /** @return BelongsTo<RecruiterEntitlement, $this> */
    public function entitlement(): BelongsTo
    {
        return $this->belongsTo(RecruiterEntitlement::class, 'entitlement_id');
    }

    /** @return HasOne<Conversation, $this> */
    public function conversation(): HasOne
    {
        return $this->hasOne(Conversation::class, 'contact_request_id');
    }
