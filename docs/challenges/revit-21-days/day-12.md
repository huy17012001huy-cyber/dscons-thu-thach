# Ngày 12 — Hoàn thiện chức năng chính và báo lỗi rõ ràng

**Hình thức:** Tự thực hành · **Thời lượng:** 75 phút

## Hôm nay làm gì?

Bạn đưa tool qua cả trường hợp bình thường và dữ liệu thiếu để AI bổ sung thông báo dễ hiểu.

## Kết quả cần đạt

MVP không dừng toàn bộ chỉ vì một phần tử có vấn đề.
...
5. Chuẩn bị ít nhất ba tình huống: bình thường, không có dữ liệu và input sai.
6. Yêu cầu AI thêm guard/summary để người dùng biết cần sửa gì.
7. Chạy từng tình huống; không kết luận đạt chỉ vì happy path chạy được.
...
- Ảnh màn hình kết quả thật của ngày 12.
- Có kết quả đúng cùng thông báo xử lý được/không xử lý được.
